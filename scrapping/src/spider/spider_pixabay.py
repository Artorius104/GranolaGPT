...
queries = [
    ...
    "sorrow", "sorrowful+human", "sorrowful+person", "sorrowful+man", "sorrowful+woman", "sorrowful+boy", "sorrowful+girl",
    ...
    "despondent+human", "despondent+person", "despondent+man", "despondent+woman", "despondent+boy", "despondent+girl",
    "forlorn+person", "forlorn+person", "forlorn+man",
]
